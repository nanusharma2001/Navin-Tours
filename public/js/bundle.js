...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmFudWNoZWYiLCJhIjoiY2tyYjE2cmx3NDd5ZjJybnhvbDg0azJ3dyJ9.IVwUsJ9o96AkIPch_LIxwg';
...
var stripe = Stripe('pk_test_51JPAhwSDVVqkO1dAph7Cl3zyjfGX1xqWEgzjtr3AlhDobogvbk01LN193u4GfDyanA1cBBUbJhiTqFxrUFO7SFVw00mBUfj0OR');
...
var userPassswordForm = document.querySelector('.form-user-password');
...
if (userPassswordForm) {
  userPassswordForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              //we use await here as we want to clear the text fields after we have updated password so in background it will update and meanwhile we will clear the password fields
